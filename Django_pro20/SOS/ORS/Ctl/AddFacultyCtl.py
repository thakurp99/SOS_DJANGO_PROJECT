...
class AddFacultyCtl(BaseCtl):
    ...
    def input_validation(self):
        ...
        if (DataValidator.isNull(self.form['firstName'])):
            ...
            if (DataValidator.isalphacheck(self.form['firstName'])):
                inputError['firstName'] = "First Name conatains only letter"
                self.form['error'] = True
    ...
    def submit(self, request, params={}):
        if (params['id'] > 0):
            ...
            if dup.count() > 0:
                ...
                res = render(request, self.get_template(), {'form': self.form, 'courseList': self.course_List, 'collegeList': self.course_List, 'subjectList': self.subject_List})
            else:
            ...
            if (duplicate.count() > 0):
                ...
                self.form['messege'] = "Email already exists"
                res = render(request, self.get_template(), {
                    'form': self.form, 'courseList': self.course_List, 'collegeList': self.course_List,
    ...
    # Template html of Addfacualty page
